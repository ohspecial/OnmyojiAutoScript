...
class ConfigManual:
    ...
    SCHEDULER_PRIORITY = """
        ...
        > AreaBoss > GoldYoukai > ExperienceYoukai > Nian > NianTrue > Tako > AutoCheckinBigGod > RealmRaid > RyouToppa > DailyTrifles > Exploration
        ...
        > TrueOrochi > RichMan
        > MetaDemon > FrogBoss > FloatParade > Quiz > KittyShop > DyeTrials > MemoryScrolls > AutoCake > MultiAccountDaily
        """
