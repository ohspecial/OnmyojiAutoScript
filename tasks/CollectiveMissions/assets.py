...
class CollectiveMissionsAssets: 
	...
	# 判断是否到达 
	I_CM_RECORDS = RuleImage(roi_front=(1034,626,54,63), roi_back=(1034,626,54,63), threshold=0.8, method="Template matching", file="./tasks/CollectiveMissions/cm/cm_cm_records.png")
	# 将材料拉满的按钮，用来判断是否拉满 
