...
class ExplorationAssets: 
	...
	# Image Rule Assets
	# 好友列表打开 
	I_EXPLORE_FRIENDS_FLAG_ON = RuleImage(roi_front=(350,119,112,32), roi_back=(350,119,112,32), threshold=0.8, method="Template matching", file="./tasks/Exploration/explore_invite/explore_invite_explpre_friends_flag_on.png")
	# 好友列表关闭 
