...
class DokanAssets: 
	...
	# 道馆内式神录 
	I_RYOU_DOKAN_SHIKIGAMI = RuleImage(roi_front=(990,604,82,66), roi_back=(960,580,140,120), threshold=0.8, method="Template matching", file="./tasks/Dokan/res/res_ryou_dokan_shikigami.png")
	# 优先攻击选项 
