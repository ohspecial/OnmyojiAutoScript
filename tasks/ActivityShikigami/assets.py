...
class ActivityShikigamiAssets: 
	...
	# 定位 
	I_LOCATION = RuleImage(roi_front=(1216,397,29,33), roi_back=(1216,397,29,33), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_location.png")
	...
	# 100体活动门票检测 
	O_REMAIN_AP100 = RuleOcr(roi=(978,26,48,30), area=(978,26,48,30), mode="Digit", method="Default", keyword="", name="remain_ap100")
	# 进入100体活动标识 
	...
	# 点击进入boss战斗页面 
	I_TO_BATTLE_BOSS = RuleImage(roi_front=(1079,186,37,136), roi_back=(971,91,234,327), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_to_battle_boss.png")
	# description 
