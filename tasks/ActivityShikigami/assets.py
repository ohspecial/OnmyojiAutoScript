...
class ActivityShikigamiAssets: 
	...
	# 进入爬塔 
	I_BATTLE = RuleImage(roi_front=(1111,180,35,165), roi_back=(861,134,350,315), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_battle.png")
	# 归鹿之途 
