...
class RealmRaidAssets: 
	...
	# 第一个击破 
	I_RAID_SUCCESS = RuleImage(roi_front=(405,169,50,46), roi_back=(405,169,50,46), threshold=0.6, method="Template matching", file="./tasks/RealmRaid/res/res_raid_success.png")
