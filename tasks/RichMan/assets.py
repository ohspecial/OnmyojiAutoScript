...
class RichManAssets: 
	...
	# 已选中契灵商店 
	I_MALL_BONDLINGS_ON = RuleImage(roi_front=(412,420,92,31), roi_back=(99,419,1023,35), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_bondlings_on.png")
	# 契灵商店 
	...
	# Ocr Rule Assets
	# 蛇皮剩余可买的 
	O_SCA_NUMBER_OROCHI = RuleOcr(roi=(44,322,28,18), area=(44,322,28,18), mode="Digit", method="Default", keyword="", name="sca_number_orochi")
	# 首领御魂剩余可买的 
	...
	# 永生之海 
	O_SCA_RES_SEA = RuleOcr(roi=(1140,11,80,38), area=(1140,11,80,38), mode="Digit", method="Default", keyword="", name="sca_res_sea")
