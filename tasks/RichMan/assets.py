...
class RichManAssets: 
	...
	# Image Rule Assets
	# 蓝票 
	I_CH_BLUE = RuleImage(roi_front=(624,146,143,111), roi_back=(581,76,460,500), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/charisma/charisma_ch_blue.png")
	# description 
	I_CH_BLACK = RuleImage(roi_front=(853,387,141,110), roi_back=(576,79,525,509), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/charisma/charisma_ch_black.png")
	# 蓝票购买确认 
	...
	# 白蛋确认 
	I_FS_WHITE_CHECK = RuleImage(roi_front=(597,224,100,100), roi_back=(554,111,246,216), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/friendship_points/friendship_points_fs_white_check.png")
	...
	# 随机御魂 
	I_ME_SOULS = RuleImage(roi_front=(631,131,129,115), roi_back=(121,83,898,509), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_souls.png")
	# 白蛋 
	...
	# 御灵挑战券 
	I_ME_CHALLENGE_PASS = RuleImage(roi_front=(847,134,145,111), roi_back=(114,89,925,491), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_challenge_pass.png")
	# 红蛋 
	...
	# 购买检查 
	I_ME_CHECK_BLACK = RuleImage(roi_front=(585,230,100,100), roi_back=(585,230,100,100), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_check_black.png")
	# 购买检查 
	I_ME_CHECK_BLUE = RuleImage(roi_front=(587,238,100,100), roi_back=(587,238,100,100), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_check_blue.png")
	# 购买检查 
	I_ME_CHECK_AP = RuleImage(roi_front=(588,242,100,100), roi_back=(588,242,100,100), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_check_ap.png")
	# 购买检查 
	I_ME_CHECK_SOULS = RuleImage(roi_front=(590,257,100,100), roi_back=(590,257,100,100), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_check_souls.png")
	...
	# 杂货铺 
	I_MALL_SUNDRY_CHECK = RuleImage(roi_front=(1050,0,31,44), roi_back=(1050,0,150,100), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_sundry_check.png")


	# Image Rule Assets
	# 特殊 
	I_SIDE_SURE_SPECIAL = RuleImage(roi_front=(1172,91,72,78), roi_back=(1169,93,84,192), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_sure_special.png")
	# 特殊 
	...
	# 荣誉 
	I_SIDE_SUER_HONOR = RuleImage(roi_front=(1180,191,59,60), roi_back=(1150,159,116,217), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_suer_honor.png")
	# 荣誉 
	...
	# 友情点 
	I_SIDE_SURE_FRIENDS = RuleImage(roi_front=(1190,287,43,52), roi_back=(1163,258,97,221), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_sure_friends.png")
	# 友情点 
	...
	# 勋章 
	I_SIDE_SURE_MEDAL = RuleImage(roi_front=(1190,404,39,62), roi_back=(1156,352,114,242), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_sure_medal.png")
	# 勋章 
	...
	# Ocr Rule Assets
	# 蛇皮剩余可买的 
	O_SCA_NUMBER_OROCHI = RuleOcr(roi=(41,318,34,25), area=(41,318,34,25), mode="Digit", method="Default", keyword="", name="sca_number_orochi")
	# 首领御魂剩余可买的 
	O_SCA_NUMBER_DEMON = RuleOcr(roi=(624,319,32,23), area=(624,319,32,23), mode="Digit", method="Default", keyword="", name="sca_number_demon")
	# 永生之海 
	O_SCA_NUMBER_SEA = RuleOcr(roi=(921,320,35,22), area=(921,320,35,22), mode="Digit", method="Default", keyword="", name="sca_number_sea")
	# 多少号位 
	...
	# 永生之海 
	O_SCA_RES_SEA = RuleOcr(roi=(1136,11,88,38), area=(1136,11,88,38), mode="Quantity", method="Default", keyword="", name="sca_res_sea")
