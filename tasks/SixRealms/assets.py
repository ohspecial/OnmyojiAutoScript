...
class SixRealmsAssets: 
	...
	# 结算的椒图 
	I_BOSS_SHUTU = RuleImage(roi_front=(108,141,173,122), roi_back=(33,71,316,219), threshold=0.8, method="Template matching", file="./tasks/SixRealms/moon_sea/ms/ms_boss_shutu.png")
	# description 
