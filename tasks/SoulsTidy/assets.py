...
class SoulsTidyAssets: 
	...
	# 第一个御魂是+0的 
	I_ST_LEVEL_0 = RuleImage(roi_front=(85,235,45,30), roi_back=(85,235,45,30), threshold=0.6, method="Template matching", file="./tasks/SoulsTidy/simple/simple_st_level_0.png")
	# 御魂奉纳后获得的金币 
