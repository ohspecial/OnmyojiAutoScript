...
class DuelAssets: 
	...
	# Image Rule Assets
	# 点击阵容 
	I_D_TEAM = RuleImage(roi_front=(814,296,33,63), roi_back=(785,259,115,119), threshold=0.8, method="Template matching", file="./tasks/Duel/duel/duel_d_team.png")
	# 一键切换所有的御魂 
	...
	# 战斗带保护的 
	I_D_BATTLE_PROTECT = RuleImage(roi_front=(439,289,85,83), roi_back=(1118,553,155,149), threshold=0.8, method="Template matching", file="./tasks/Duel/duel/duel_d_battle_protect.png")
	# 自动上阵 
	...
	# 斗技模式（普通） 
	I_BATTLE_TYPE_COMMON = RuleImage(roi_front=(35,18.5,90,66), roi_back=(439,278,90,88), threshold=0.8, method="Template matching", file="./tasks/Duel/duel/duel_battle_type_common.png")
	# 活动的战斗按钮 
	...
	# 左上角的退出 
	I_DUEL_EXIT = RuleImage(roi_front=(28,11,38,36), roi_back=(4,1,100,71), threshold=0.8, method="Template matching", file="./tasks/Duel/duel/duel_duel_exit.png")
	# description 
	I_SHARE_BUTTON = RuleImage(roi_front=(1146,626,52,45), roi_back=(1146,626,52,45), threshold=0.8, method="Template matching", file="./tasks/Duel/duel/duel_share_button.png")


	# Ocr Rule Assets
	# 荣誉 
	O_D_HONOR = RuleOcr(roi=(149,665,105,24), area=(149,665,105,24), mode="DigitCounter", method="Default", keyword="", name="d_honor")
	# 分数 
