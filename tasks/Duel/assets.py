...
class DuelAssets: 
	...
	# 战斗带保护的 
	I_D_BATTLE_PROTECT = RuleImage(roi_front=(1153,578,100,100), roi_back=(1118,553,155,149), threshold=0.6, method="Template matching", file="./tasks/Duel/duel/duel_d_battle_protect.png")
	# 自动上阵 
	...
	# 胜利分享 
	I_D_WIN_SHARE = RuleImage(roi_front=(1123,608,82,73), roi_back=(1121,607,85,75), threshold=0.8, method="Template matching", file="./tasks/Duel/duel/d_win_share.png")
