...
class GeneralRoomAssets: 
	...
	# description 
	I_CREATE_ENSURE = RuleImage(roi_front=(832,565,86,50), roi_back=(471,463,471,257), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralRoom/gr/gr_create_ensure.png")
	# 勾选不公开的图 
