...
class GeneralInviteAssets: 
	...
	# 队员接受邀请 
	I_I_ACCEPT = RuleImage(roi_front=(113,225,63,72), roi_back=(113,225,63,280), threshold=0.6, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_i_accept.png")
	# 队员默认接受邀请 
