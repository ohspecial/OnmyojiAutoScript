...
class GeneralBattleAssets: 
	...
	# 红标BOSS 
	C_RED_BOSS = RuleClick(roi_front=(382,14,48,40), roi_back=(382,14,48,40), name="red_boss")
	...
	# 失败 
	I_FALSE = RuleImage(roi_front=(413,124,95,95), roi_back=(272,63,410,227), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_false.png")
	# 确认预设的队伍 
