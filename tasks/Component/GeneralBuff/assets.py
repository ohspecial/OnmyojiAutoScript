...
class GeneralBuffAssets: 
	...
	# description 
	I_OPEN_YELLOW = RuleImage(roi_front=(776,279,16,20), roi_back=(766,133,35,366), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_open_yellow.png")
	# description 
	I_CLOSE_RED = RuleImage(roi_front=(775,290,16,20), roi_back=(764,134,38,369), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_close_red.png")
	# 用来判定是否点击的那个 
