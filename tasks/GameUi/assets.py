...
class GameUiAssets: 
	...
	# description 
	I_CHECK_COLLECTION = RuleImage(roi_front=(401,651,64,54), roi_back=(298,639,363,76), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_collection.png")
	# description 
